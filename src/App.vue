  ...
  <div id="app">
    <nav class="sidebar">
      ...
      <div class="menu-item active">
        <img src="http://via.placeholder.com/23x23" alt="">
      ...
      <div class="menu-item" style="margin-top: 44px;">
        <img src="http://via.placeholder.com/23x23" alt="">
        <div class="text">
          Create Playlist
        </div>
...
.header {
    ...
    right: 0;
    height: 80px;
    background-image: linear-gradient(to bottom right, #2e2e2e, #262626);
    display: flex;
    align-items: center;
}
